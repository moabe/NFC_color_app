package com.example.moabergsmark.myapp23april;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //etResponse = (EditText) findViewById(R.id.etResponse);//http request
        //tvIsConnected = (TextView) findViewById(R.id.tvIsConnected);//http request
